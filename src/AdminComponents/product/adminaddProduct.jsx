...
function AdminaddProduct() {
  ...
  const [productSizes, setProductSizes] = useState([{ size: '', sizetype: '', quantity: '' }]);
  ...
  const handleAddSize = () => {
    setProductSizes([...productSizes, { size: '', sizetype: '', quantity: '' }]);
  };
  ...
  //               />
  //               </div>
  //             <button type="button" className="w-25 btn btn-danger "  onClick={() => handleRemoveSize(index)}>
  //               Delete
  //             </button>
  //           </div>
  //         ))}
  //         <button type="button" className="btn btn-primary"  onClick={handleAddSize}>
  //           Add More
  //         </button>
  //         <select
  //           className="add_product_input_filed"
